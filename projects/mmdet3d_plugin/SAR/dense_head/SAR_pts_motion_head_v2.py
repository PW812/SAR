...
class SAR_pts_motion_head_v2(DETRHead):
    """Head of SSR model.
    Args:
    ...
    def __init__(self,
        ...
        super(SAR_pts_motion_head_v2, self).__init__(*args, transformer=transformer, **kwargs)
    ...
    def forward(self,
        ...
        bev_queries =  pts_feat.permute(1, 0, 2).contiguous() #[N,B,C] 
