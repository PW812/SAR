...
model = dict(
    ...
    pts_voxel_layer=dict(
        max_num_points=10,
        voxel_size=[0.15, 0.15, 4],
        max_voxels=(80000, 120000),
        point_cloud_range=[-15.0, -30.0, -2.0, 15.0, 30.0, 2.0]),
    pts_voxel_encoder=dict(type='HardSimpleVFE', num_features=5),
    pts_middle_encoder=dict(
        type='SparseEncoder',
        in_channels=5,
        sparse_shape=[31, 800, 800],
        output_channels=128,
        order=('conv', 'norm', 'act'),
    ...
    pts_bbox_head=dict(
        ...
        loss_plan_col=dict(
            type='PlanCollisionLoss', loss_weight=1.0, agent_thresh=0.01),
    ...
    loss_img_bev=dict(type='MSELoss', loss_weight=1.0),
    loss_pts_bev=dict(type='MSELoss', loss_weight=1.0),
    train_cfg=dict(
        pts=dict(
            grid_size=[512, 512, 1],
            voxel_size=[0.15, 0.15, 4],
...
train_pipeline = [
    ...
    dict(type='CustomCollect3D',\
         keys=['gt_bboxes_3d', 'gt_labels_3d', 'img', 'ego_his_trajs','points',
...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='CustomCollect3D',\
                 keys=['points', 'gt_bboxes_3d', 'gt_labels_3d', 'img', 'fut_valid_flag','points',
